    ...
    <>
      <div className="flex flex-wrap justify-center items-center gap-14 mt-60 lg:mt-auto">
        ...
        <div className="flex flex-col gap-5 justify-center  text-blue-950 mb-10 mx-10">
          ...
          <span className="flex items-center gap-3">
            <BsCheckCircle /> go to donate cloth section
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> fill the required details
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> nearest volunteer will be informed through email
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> volunteer will contact you at address provided or
