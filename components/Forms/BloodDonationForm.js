      ...
      <div className="flex flex-wrap justify-center items-center gap-5 mt-44">
        ...
        <div className="flex flex-col gap-5 justify-center  text-blue-950 mb-10 mx-10">
          <span className="flex items-center gap-3">
            <BsCheckCircle /> Signup as a donor
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> Go to donate blood section
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> Fill the required details
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> Nearby patient in need can conatact you any time.
          </span>
          <span className="flex items-center gap-3">
            <BsCheckCircle /> Visit the hospital mentioned by patient or his
            acquintances to save life
          </span>
        </div>
