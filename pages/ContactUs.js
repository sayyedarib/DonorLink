...
import {
  ...
  response_error,
  response_success,
} from "../styles/pages/contactus.module.css";
...
const ContactUs = () => {
  ...
  const handleQuery = async () => {
    ...
    await axios
      .post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/sendQuery`, query, {
      ...
      <section className=" flex flex-wrap mx-10 mt-24 justify-between items-center">
        <div className="">
          <div className="mb-12 max-w-[570px] lg:mb-0">
            <h2 className="text-blue-800 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
              GET IN TOUCH WITH US
            </h2>
            <p className="text-body-color mb-9 text-base leading-relaxed">
              We are always ready to solve your quries, we are 100% transparent
              charity NGO , feel free to ask for any kind of questions regarding
              how we collect and distribute , how to ensure that our words are
              really true.
            </p>
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                ...
                <p className="text-body-color text-base">
                  LIG 515, Housing Board Colony, Jamalpur, Urban Estate, Phase
                  2, Near Ayyappa Temple and DCM prescidency School
                </p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                ...
                <p className="text-body-color text-base">(+91) 8604078497</p>
              </div>
            </div>
            <div className="mb-8 flex w-full max-w-[370px]">
              <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
        ...
        <div className="lg:w-[28rem] w-full p-8 my-10 bg-white rounded-xl shadow-xl shadow-blue-200">
          <h1 className="text-center text-blue-800 font-bold text-2xl">
            Contact Us
          </h1>
          ...
          <button
            type="button"
            onClick={handleQuery}
            className="w-full py-3 mt-5 font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg border-indigo-700 hover:shadow inline-flex space-x-2 items-center justify-center"
          >
