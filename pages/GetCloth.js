          ...
          {!list ? (
            <div className="flex flex-col gap-5 justify-center  text-blue-950 mb-10 mx-10">
              <span className="flex items-center gap-3">
                <BsCheckCircle /> Signup
              </span>
              <span className="flex items-center gap-3">
                <BsCheckCircle /> Go to get cloth section
              </span>
              <span className="flex items-center gap-3">
                <BsCheckCircle /> Fill the required details
              </span>
              <span className="flex items-center gap-3">
                <BsCheckCircle /> Get in touch with donors in the range of 10km
              </span>
              <span className="flex items-center gap-3">
                <BsCheckCircle /> No donors's availabele, No worry! If available
                in our collection stock , we will provide you.
              </span>
            </div>
          ) : (
            <div className="flex gap-5 flex-wrap justify-center items-center mt-10">
              {nearbyDonor.map((data) => (
                <div key={data._id}>
                  <ClothDonorsCard data={data} />
                </div>
              ))}
            </div>
          )}
