...
const ContactUs = () => {
    ...
    return (
        <div>
            ...
            <section className=" flex flex-wrap mx-20 justify-between items-center">
                        ...
                        <div className="">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p className="text-body-color mb-9 text-base leading-relaxed">
                                    We are always ready to solve your quries, we arae 100% transparent charity NGO , feel free to ask for any kind of questions regarding how we collect and distribute , how to ensure that our words are relly true.
                                </p>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">
                                            LIG 515, Housing Board Colony, Jamalpur, Urban Estate, Phase 2, Near Ayyappa Temple and DCM prescidency School 
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">sayyedaribhussain4321@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
